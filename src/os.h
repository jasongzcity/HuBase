...
int huBaseRead( huBase_file*, void* buff, int, h_i64 );   /* Read the file */
int huBaseWrite( huBase_file*, const void*, int, h_i64 ); /* Write buff */
int huBaseTruncate( huBase_file*, h_i64 );                /* Truncate file */
int huBaseSync( huBase_file*, int );                      /* Sync file */
int huBaseFileSize( huBase_file*, h_i64* );
